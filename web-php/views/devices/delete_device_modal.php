        ...
        <div class="modal-body" style="padding: 1.5rem;">
            ...
            <div style="background: rgba(239, 68, 68, 0.08); border-right: 4px solid #ef4444; border-radius: 8px; padding: 0.9rem 1.1rem; margin-bottom: 1.25rem;">
                ...
                <ul style="margin: 0; padding-right: 1.2rem; font-size: 0.83rem; color: #e2e8f0; line-height: 1.7;">
                    ...
                    <li><b>إزالة حماية المالك (Device Owner):</b> إزالة الحظر عن إلغاء تثبيت التطبيق وتمكين حذف الأيجنت من الجهاز بحرية.</li>
                    <li><b>مسح بيانات الأيجنت:</b> تصفير قاعدة بيانات الجهاز المحلية وإلغاء مفاتيح التشفير وإيقاف الخدمات.</li>
            ...
            <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.5; margin-bottom: 1.25rem;">
                ⚠️ هذا الإجراء فوري ونهائي ولا يمكن التراجع عنه. إذا كنت ترغب في إعادة مراقبة هذا الجهاز مستقبلاً، سيتعين عليك مسح رمز الاقتران من جديد وإعادة تثبيته.
            </p>
